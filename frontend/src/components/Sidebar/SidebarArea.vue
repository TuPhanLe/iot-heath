...
const menuGroups = ref([
  {
    ...
    menuItems: [
      ...
      //   route: '#',
      //   children: [
      //     { label: 'All doctors', route: '/doctor/doctor_index' },
      //     { label: 'Add doctor', route: '/doctor/doctor_add' }
      //   ]
      // },
      // {
      //   icon: `<svg
      ...
      //   route: '#',
      //   children: [
      //     { label: 'All Appointment', route: '/appoint/appoint_index' },
      //     { label: 'Add Appointment', route: '/appoint/appoint_add' }
      //   ]
      // },
      {
        icon: `<svg
    ...
    <div class="flex items-center justify-between gap-2 px-6 py-5 lg:py-6.5">
      <a href="/" class="flex items-center ps-2.5 mt-5">
        <img
          ...
          class="h-15 me-3 sm:h-11"
          alt="Flowbite Logo"
        />
        <span class="self-center text-2xl font-extrabold whitespace-nowrap text-white mt-3"
          >IOT HEALTH</span
        >
      </a>
      ...
      <nav class="mt-5 py-4 px-4 lg:mt-9 lg:px-6">
        <template v-for="menuGroup in menuGroups" :key="menuGroup.name">
          <div>
            ...
            <ul class="mb-8 flex flex-col gap-1.5">
              <SidebarItem
